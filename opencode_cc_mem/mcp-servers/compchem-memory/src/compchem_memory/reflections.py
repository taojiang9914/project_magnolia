...
OPENING_QUOTES = [
    ...
    "是故天将降大任于斯人也，必先苦其心志，劳其筋骨，饿其体肤，空乏其身，行拂乱其所为，所以动心忍性，增益其所不能 — When Heaven is about to confer a great responsibility on a man, it will exercise his mind with suffering, subject his sinews and bones to hard work, expose his body to hunger, put his possessions in confusion, and frustrate his every attempt — so as to stimulate his mind, harden his nature, and improve his capabilities.",
    ...
    "祸兮福之所倚，福兮祸之所伏 — Misfortune leans on fortune, and fortune hides within misfortune.",
    ...
    "名不正则言不顺，言不顺则事不成 — If names are not correct, language is not in accord; if language is not in accord, affairs do not succeed.",
...
CLOSING_QUOTES = [
    ...
    "致中和，天地位焉，万物育焉 — Achieve harmony and balance, and Heaven and Earth find their places, and all things flourish.",
    "博学而笃志，切问而近思，仁在其中矣 — Study widely, hold fast to your purpose, inquire earnestly, and reflect closely — benevolence lies in these.",
    "不积跬步，无以至千里；不积小流，无以成江海 — Without accumulating small steps, one cannot reach a thousand li; without gathering small streams, one cannot form rivers and seas.",
    ...
    "博学而无所成名 — Study broadly, yet be known for no single specialty.",
    ...
    "为者败之，执者失之。是以圣人无为故无败，无执故无失 — Those who act on it destroy it; those who grasp at it lose it. Therefore the sage does not act, and so does not destroy; does not grasp, and so does not lose.",
